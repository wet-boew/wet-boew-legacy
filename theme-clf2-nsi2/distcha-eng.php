<?php
//http://www.rodsdot.com/php/How-To-Obtain-A-GUID-Using-PHP-pseudo.php didnt work
...
<head>
	...
	<title>Device Independent Slider Test to tell Computers and Humans Apart (DISTCHA) - HTML5 - Web Experience Toolkit (WET)</title>
...
<!-- clf2-nsi2 theme ends / Fin du thème clf2-nsi2 -->
	...
	<link media="all" type="text/css" rel="stylesheet" href="../js/support/distcha/style.css">
		...
		<nav role="navigation">
			...
			<div id="cn-bcrumb">
				...
				<ol>
					...
					<li><abbr title="Device Independent Slider Test to tell Computers and Humans Apart">DISTCHA</abbr> - HTML5 - Web Experience Toolkit (WET)</li>
				</ol>
			</div>
...
<!-- clf2-nsi2 theme ends / Fin du thème clf2-nsi2 -->
	...
	<div id="cn-centre-col" role="main"><div id="cn-centre-col-inner">
		...
		<h1 id="cn-cont">Device Independent Slider Test to tell Computers and Humans Apart (DISTCHA) - HTML5 - Web Experience Toolkit (WET)</h1>
		<!-- Content Title ends / Fin du titre du contenu -->

<!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->
		<section>
			<h2><abbr title="Device Independent Slider Test to tell Computers and Humans Apart">DISTCHA</abbr> Proof of Concept</h2>
			<form action="reverse-turing-test.php" method="post">
				<fieldset>
					<input id="captchaValue" name="captchaValue" type="hidden" value="<?php echo $fileID; ?>" />
					<div class="field">
						<label for="captcha">Please, move the slider cursor all the way through to 100%.</label>
						<div class="captchaContainer">
							<!-- <input id="captcha" class="cursor draggable" type="image" alt="Use the right arrow key to slide the cursor all the way through to one hundred percent." src="../distcha/slide-me.gif" /> -->
							<input id="captcha" class="cursor draggable" type="button" value="Slide me!" />
						</div>
					</div>
				</fieldset>
				<div class="controls">
			...
			<div id="captchaSuccessMessageContainer">
				<p id="captchaSuccessMessage"></p>
			</div>
		</section>
<!-- clf2-nsi2 theme ends / Fin du thème clf2-nsi2 -->
	</div></div>
