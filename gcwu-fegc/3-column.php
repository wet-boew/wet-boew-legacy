...
<!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->
			<p><?php _e("<!--:en-->Sorry, no posts matched your criteria.<!--:--><!--:fr-->Désolé, aucun article ne correspond à vos critères.<!--:-->"); ?></p>
			<?php get_search_form(); ?>
		<?php endif; ?>
<!-- Date Modified begins / Début de la date de modification -->
			<dl id="cn-doc-dates" role="contentinfo">
				...
				<dd><span><time pubdate="pubdate" itemprop="dateModified"><?php the_time('Y-m-d') ?></time></span></dd>
			</dl>
			<div class="clear"></div>
