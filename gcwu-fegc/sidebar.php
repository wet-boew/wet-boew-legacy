...
?>
        ...
        <div id="cn-left-col"><div id="cn-left-col-inner"><nav role="navigation"><h2 id="cn-nav"><?php _e("<!--:en-->Side navigation (left column)<!--:--><!--:fr-->Navigation latérale (colonne gauche)<!--:-->"); ?></h2>
